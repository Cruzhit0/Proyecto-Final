                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-md-8 col-lg-6">
                        <div class="card-form p-4">
                            ...
                            <form action="<?= base_url('panel/habitacionesTipo/store') ?>" method="post">
                                <?= csrf_field() ?> <!-- ¡No olvides esto! -->
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control <?= isset($errors['descripcion']) ? 'is-invalid' : '' ?>" 
                                      ...
                                      name="descripcion" 
                                      rows="3" 
                                      placeholder="Descripción del tipo de habitación..."><?= old('descripcion') ?></textarea>
                                  ...
                                  <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        value="<?= old('capacidad_maxima', 2) ?>" 
                                        min="1" 
                                        max="10" 
                                        step="1"
                                        required>
                                        <?php if (isset($errors['capacidad_maxima'])): ?>
                                        <div class="invalid-feedback"><?= esc($errors['capacidad_maxima']) ?></div>
                                        <?php endif; ?>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        id="precio_noche" 
                                        name="precio_noche" 
                                        value="<?= old('precio_noche', '0.00') ?>" 
                                        min="0.01" 
                                        required>
                                        <?php if (isset($errors['precio_noche'])): ?>
                                        <div class="invalid-feedback"><?= esc($errors['precio_noche']) ?></div>
                                        <?php endif; ?>
                                    </div>
                                </div>
